...
code([
    ...
    "\n",
    "# Load the curated, Python-executable tool registry (real entry_points the\n",
    "# BioChatter adapter can bind) AND merge data/mcp_registry.yaml.\n",
    "_reg1 = os.path.join(ST2_DIR, 'registry.yaml')\n",
    "_reg2 = os.path.join(ST2_DIR, 'data', 'mcp_registry.yaml')\n",
    "_tools_a = yaml.safe_load(open(_reg1, encoding='utf-8'))['tools']\n",
    "try:\n",
    "    _tools_b = yaml.safe_load(open(_reg2, encoding='utf-8'))['tools']\n",
    "except Exception:\n",
    "    _tools_b = []\n",
    "_seen = set(); tools = []\n",
    "for _t in list(_tools_a) + list(_tools_b):\n",
    "    _n = _t.get('name')\n",
    "    if _n in _seen: continue\n",
    "    _seen.add(_n); tools.append(_t)\n",
